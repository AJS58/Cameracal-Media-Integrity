...
function currentReportData(){
  return {
    version: "v5.1 Final UI + Reporting",
...
This web version checks visible files and folders. True deleted-sector recovery requires a desktop recovery engine.`;
  downloadBlob("cameracal-card-health-v5-1-diagnostic-log.txt", content, "text/plain");
}
...
<div class="report">
  ...
  downloadBlob("cameracal-card-health-v5-1-interactive-report.html", html, "text/html");
}
